...
EXERCICES =
  ...
  "1" :
    ...
    "texte"            : "<p>Voilà des alligators affamés...Les alligators affamés sont voraces. Ils vont manger tout ce qui est devant eux (au point de mourir d'indigestion)! Mais ils sont aussi des alligators responsables, et comme les vieux alligators, ils gardent leurs familles.</p><p>Allez fais glisser !</p>"
  ...
  "5" :
    "titre"            : 'Manger'
    "texte"            : "<p>Attention, ça va se compliquer !</p><p>Voici deux familles, l'une à coté de l'autre. L'alligator vert est affamé, c'est sûr, et il y a cette appétissante famille jaune juste en face de lui... La suite, tu la connais ?! Appuye sur le bouton 'Animer'.</p>"
